            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
                ...
                <div className="mb-6 space-y-3">
                    ...
                    <p className="text-gray-600 text-sm text-center">
                        To activate your account, please contact the administrator on WhatsApp to complete the payment process.
                    </p>
                </div>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full py-3 px-4 bg-blue-50 hover:bg-blue-100 text-blue-600 font-medium rounded-lg transition-colors text-center mb-4"
                >
