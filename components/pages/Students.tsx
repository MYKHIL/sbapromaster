...
const Students: React.FC<StudentsProps> = ({ onNavigate }) => {
    ...
    const handleConfirmPermanentDelete = () => {
        if (idsToPermanentlyDelete.length > 0) {
            idsToPermanentlyDelete.forEach(id => permanentlyDeleteItem('students', id));
        }
    ...
    return (
        <div className="space-y-6">
                        ...
                        {(currentUser?.role === 'Admin' || (currentUser?.role === 'Teacher' && (currentUser?.allowedClasses || []).length > 0)) && (
                            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    >
                                        <svg
                                            className="h-5 w-5 text-green-600 transition-transform duration-200 group-hover:scale-110"
                                            fill="currentColor"
                                            viewBox="0 0 16 16"
                                        >
            ...
            <RestoreModal
                ...
                onRestore={(ids) => restoreItem('students', ids)}
            ...
            <ConfirmationModal
                ...
                message={
                    <>
                        Are you sure you want to <span className="font-bold text-red-600 underline">permanently delete</span> {idsToPermanentlyDelete.length > 1 ? 'these selected students' : 'this student'}? 
                        <br /><br />
