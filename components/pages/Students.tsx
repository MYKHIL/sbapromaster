                ...
                <div className="flex items-center justify-between">
                    ...
                    {(currentUser?.role === 'Admin' || (currentUser?.role === 'Teacher' && currentUser.allowedClasses.length > 0)) && (
                        <button
                            ...
                            disabled={!isDirty('students') || isSyncing || !isOnline}
                            className={`flex items-center gap-2 px-5 py-2.5 rounded-lg transition-all shadow-md ${(!isDirty('students') || isSyncing || !isOnline)
                            ...
                            title={
                                !isOnline
                                    ...
                                    : !isDirty('students')
                                        ? "No unsaved changes"
                                        : "Save student data to the cloud"
                            }
                        >
                            {isSyncing ? (
                                <>
