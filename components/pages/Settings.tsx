        ...
        <div className="flex items-center justify-between">
          ...
          {isAdmin && (
            <button
              ...
              disabled={!isDirty('settings') || isSyncing || !isOnline}
              className={`flex items-center gap-2 px-5 py-2.5 rounded-lg transition-all shadow-md ${(!isDirty('settings') || isSyncing || !isOnline)
              ...
              title={
                !isOnline
                  ...
                  : !isDirty('settings')
                    ? "No unsaved changes"
                    : "Save school settings to the cloud"
              }
            >
              {isSyncing ? (
                <>
